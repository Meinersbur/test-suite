...
set(PROGRAM_IS_NONDETERMINISTIC ON)
set(TIME_FROM_OUTPUT ON)
...
function (polybench_target target name)
  ...
  target_compile_definitions(${target} PRIVATE -DPOLYBENCH_USE_RESTRICT -DPOLYBENCH_TIME -DBOOST_UBLAS_NDEBUG -DNDEBUG ${ARGN})
