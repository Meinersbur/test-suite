...
static int polybench_papi_counters_threadid = POLYBENCH_THREAD_MONITOR;
static double polybench_program_total_flops = 0;
...
static void polybench_flush_cache()
{
...
static void polybench_linux_fifo_scheduler()
{
...
static void polybench_linux_standard_scheduler()
{
...
static void polybench_papi_init()
{
# ifdef _OPENMP
#pragma omp parallel
  {
...
static void polybench_papi_close()
{
# ifdef _OPENMP
#pragma omp parallel
  {
...
static int polybench_papi_start_counter(int evid)
{
...
static void polybench_papi_stop_counter(int evid)
{
# ifdef _OPENMP
# pragma omp parallel
  {
...
static void polybench_papi_print()
{
  int verbose = 0;
# ifdef _OPENMP
# pragma omp parallel
...
static void polybench_prepare_instruments()
{
#ifndef POLYBENCH_NO_FLUSH_CACHE
  polybench_flush_cache ();
#endif
...
static void polybench_timer_start()
{
...
static void polybench_timer_stop()
{
#ifndef POLYBENCH_CYCLE_ACCURATE_TIMER
...
static void polybench_timer_print()
{
...
static void polybench_free_data(void* ptr)
{
#ifdef POLYBENCH_ENABLE_INTARRAY_PAD
...
static void* polybench_alloc_data(unsigned long long int n, int elt_size)
{
#ifdef POLYBENCH_ENABLE_INTARRAY_PAD
